...
# from models.DI_RIFE.model.IFNet import *
from models.DI_RIFE.model.IFNet_m import *
import torch.nn.functional as F
from models.DI_RIFE.model.loss import *
from models.DI_RIFE.model.laplacian import *
from models.DI_RIFE.model.refine import *
...
class Model:
    ...
    def load_model(self, path, rank=0):
        ...
        if rank <= 0:
            self.flownet.load_state_dict(convert(torch.load('{}/flownet_m.pkl'.format(path))))

    def save_model(self, path, rank=0):
        if rank == 0:
            torch.save(self.flownet.state_dict(), '{}/flownet_m.pkl'.format(path))
