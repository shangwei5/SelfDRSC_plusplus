...
from models.DI_RIFE.model.warplayer import warp
...
class IFNet_m(nn.Module):
    ...
    def forward(self, x, scale=[4, 2, 1], timestep=None, returnflow=False):
        ...
        for i in range(3):
            if flow != None:
                # print(img0.shape, img1.shape, timestep.shape, warped_img0.shape, warped_img1.shape, mask.shape)
